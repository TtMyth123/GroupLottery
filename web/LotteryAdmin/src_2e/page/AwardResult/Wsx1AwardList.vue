        ...
        <el-dialog title="Chi tiết" :visible.sync="detailVisible" width="90%">
          ...
          <el-form ref="form" :inline="true" :model="tableDataDetail" label-width="100px">
            ...
            <el-form-item label="SecondNum">
              <el-input v-model="tableDataDetail.Result.secondNum"></el-input>
            </el-form-item>
            <el-divider></el-divider>
            ...
            <el-form-item label="">
              <el-input v-model="tableDataDetail.Result.forthNum[5]"></el-input>
            </el-form-item>
            <el-form-item label="">
              <el-input v-model="tableDataDetail.Result.forthNum[6]"></el-input>
            </el-form-item>
            <el-divider></el-divider>

            <el-form-item label="fifthNum">
              <el-input v-model="tableDataDetail.Result.fifthNum"></el-input>
            </el-form-item>
            <el-divider></el-divider>
            ...
            <el-form-item label="seventhNum">
              <el-input v-model="tableDataDetail.Result.seventhNum"></el-input>
            </el-form-item>
            <el-divider></el-divider>

            <el-form-item label="eighthNum">
              <el-input v-model="tableDataDetail.Result.eighthNum"></el-input>
            </el-form-item>
...
<!--            <el-button @click="detailVisible=false">Huỷ</el-button>-->
      ...
      <el-dialog title="Tạo kết quả kiểm tra" :visible.sync="testAwardVisible" width="250px">
        Chắc chắn muốn tạo kết quả kiểm tra không？
        <span slot="footer" class="dialog-footer">
    ...
    export default {
        ...
        data() {
            return {
                ...
                tableData: [],
                tableDataDetail:{GameName:"",LotteryStr:"",Result:{jackpots:"",firstNum:"",
                    secondNum:"",thirdNum:["",""],forthNum:["","","","","","",""],fifthNum:"",
