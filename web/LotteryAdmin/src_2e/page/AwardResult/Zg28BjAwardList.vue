  ...
  <div>
    <div class="container">
      ...
      <el-table
        ...
        <el-table-column prop="ResultNums" label="Kết quả mở thưởn">
...
<!--            <el-button @click="detailVisible=false">Huỷ</el-button>-->
    ...
    <el-dialog title="Tạo kết quả kiếm tra" :visible.sync="testAwardVisible" width="150">
                <span slot="footer" class="dialog-footer">
    ...
    addTestAward(){
      ...
      request({ url: 'api/addtestaward', method: 'post', data: data }).then((res) => {
        if (res.code == 200) {
          ...
          this.getData();
          this.$message.success('Thêm vào thành côn');
        } else {
