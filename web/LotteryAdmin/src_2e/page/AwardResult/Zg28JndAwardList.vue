  ...
  <div>
    <div class="container">
      ...
      <el-table
        ...
        <el-table-column prop="CurLotteryTime" label="Kết quả mở thưởng"></el-table-column>
      </el-table>
    ...
    <el-dialog title="Chỉnh sửa cửa sổ bật lên" :visible.sync="detailVisible" width="90%">
...
<!--            <el-button @click="detailVisible=false">Xác nhận</el-button>-->
    ...
    <el-dialog title="Tạo kết quả kiểm tra" :visible.sync="testAwardVisible" width="150">
                <span slot="footer" class="dialog-footer">
            <el-button @click="testAwardVisible=false">Xác nhận</el-button>
