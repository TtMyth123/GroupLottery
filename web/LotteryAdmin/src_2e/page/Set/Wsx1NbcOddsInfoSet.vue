    ...
    <div>
        <div class="container">
          <el-tabs v-model="activeName" >
            ...
            <el-tab-pane label="To Nh? L? Nh?n" name="tab0">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    ...
                    <el-button type="primary" class="handle-del mr10" @click="batchModifyOdds(0)" >Ch?nh s?a hàng lo?t</el-button>
                  </el-breadcrumb-item>
                </div>
              </el-card>
              <el-card class="box-card">
                <el-button type="primary" class="handle-del mr10" @click="getData(0 )" >Làm m?i</el-button>
                <el-table
                ...
                >
                  ...
                  <el-table-column prop="OddsType" label="Nhan Key" width="90" align="center"></el-table-column>
                  <el-table-column prop="OddsDes" label="Tên nhan"></el-table-column>
                  <el-table-column prop="Odds" label="Nhan">
                    <template slot-scope="scope">{{scope.row.Odds|money}}</template>
                  </el-table-column>

                  <el-table-column prop="OneUserMinBet" label="T?i thi?u 1 ng??i"></el-table-column>
                  <el-table-column prop="OneUserMaxBet" label="T?i ?a 1 ng??i"></el-table-column>
                  <el-table-column prop="AllUserMaxBet" label="T?i ?a toàn b?"></el-table-column>

                  <el-table-column label="?i?u hành" width="180" align="center">
            ...
            <el-tab-pane label="Gi?i ??c bi?t-S? ??u ??c bi?t" name="tab1">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    Nhan Key Ph?m vi（
                    ...
                    <el-button type="primary" class="handle-del mr10" @click="batchModifyOdds(1)" >S?a ??i hàng lo?t</el-button>
                  </el-breadcrumb-item>
                </div>
              </el-card>
              <el-card class="box-card">
                <el-button type="primary" class="handle-del mr10" @click="getData(1)" >Làm m?i</el-button>
                <el-table
            ...
            <el-tab-pane label="Gi?i ??c bi?t-S? ?u?i ??c bi?t" name="tab2">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    Nhan Key Ph?m vi（
                    ...
                    <el-button type="primary" class="handle-del mr10" @click="batchModifyOdds(2)" >S?a ??i hàng lo?</el-button>
                  </el-breadcrumb-item>
                </div>
              </el-card>
              <el-card class="box-card">
                <el-button type="primary" class="handle-del mr10" @click="getData(2)" >Làm m?i</el-button>
                <el-table
            ...
            <el-tab-pane label="Gi?i nh?t-S? ??u gi?i nh?t" name="tab11">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    Nhan KeyPh?m vi（
                    ...
                    <el-button type="primary" class="handle-del mr10" @click="batchModifyOdds(11)" >S?a ??i hàng lo?t</el-button>
                  </el-breadcrumb-item>
                </div>
              </el-card>
              <el-card class="box-card">
                <el-button type="primary" class="handle-del mr10" @click="getData(11)" >Làm m?i</el-button>
                <el-table
            ...
            <el-tab-pane label="Gi?i nh?t-S? ?u?i gi?i nh?t" name="tab12">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    Nhan Key Ph?m vi（
                    <el-input-number class="loose-input" v-model="allData[12].BatchForm.MinValue" :step="1" :min="allData[12].BatchForm.Min" :max="allData[12].BatchForm.Max"> </el-input-number>
                    ~
                    <el-input-number class="loose-input" v-model="allData[12].BatchForm.MaxValue" :step="1" :min="allData[12].BatchForm.Min" :max="allData[12].BatchForm.Max"> </el-input-number>）
                    Nhan：
                    <el-input-number class="loose-input" v-model="allData[12].BatchForm.Odds" :precision="2" :step="1" :min="0"></el-input-number>
                    <el-button type="primary" class="handle-del mr10" @click="batchModifyOdds(12)" >S?a ??i hàng lo?t</el-button>
                  </el-breadcrumb-item>
                </div>
              </el-card>
              <el-card class="box-card">
                <el-button type="primary" class="handle-del mr10" @click="getData(12)" >Làm m?i</el-button>
                <el-table
                    :data="allData[12].tableData"
                    border
                    class="table"
                    ref="multipleTable"
                    header-cell-class-name="table-header"
                >
                  ...
                  <el-table-column prop="OneUserMinBet" label="i thi?u 1 ng??i"></el-table-column>
                  <el-table-column prop="OneUserMaxBet" label="T?i ?a 1 ng??i"></el-table-column>
                  <el-table-column prop="AllUserMaxBet" label="T?i ?a toàn b?"></el-table-column>
                  ...
                  <el-table-column label="?i?u hành" width="180" align="center">
                    <template slot-scope="scope">
                      <el-button
                          type="text"
                          icon="el-icon-edit"
                          @click="handleEdit(12,scope.$index, scope.row)"
                      >Ch?nh s?a
                      </el-button>
                    </template>
                  </el-table-column>
            ...
            <el-tab-pane label="Gi?i nh?-S? ??u gi?i nhì" name="tab13">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    Nhan Key Ph?m vi（
                    <el-input-number class="loose-input" v-model="allData[13].BatchForm.MinValue" :step="1" :min="allData[13].BatchForm.Min" :max="allData[13].BatchForm.Max"> </el-input-number>
                    ~
                    <el-input-number class="loose-input" v-model="allData[13].BatchForm.MaxValue" :step="1" :min="allData[13].BatchForm.Min" :max="allData[13].BatchForm.Max"> </el-input-number>）
                    Nhan：
                    <el-input-number class="loose-input" v-model="allData[13].BatchForm.Odds" :precision="2" :step="1" :min="0"></el-input-number>
                    <el-button type="primary" class="handle-del mr10" @click="batchModifyOdds(13)" >S?a ??i hàng lo?t</el-button>
                  </el-breadcrumb-item>
                </div>
              </el-card>
              <el-card class="box-card">
                <el-button type="primary" class="handle-del mr10" @click="getData(13)" >Làm m?i</el-button>
                <el-table
                    :data="allData[13].tableData"
                    border
                    class="table"
                    ref="multipleTable"
                    header-cell-class-name="table-header"
                  ...
                  <el-table-column label="?i?u hành" width="180" align="center">
                    <template slot-scope="scope">
                      <el-button
                          type="text"
                          icon="el-icon-edit"
                          @click="handleEdit(13,scope.$index, scope.row)"
                      >Ch?nh s?a
                      </el-button>
                    </template>
                  </el-table-column>
            ...
            <el-tab-pane label="Gi?i nhì-S? ?u?i gi?i nhì" name="tab14">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    Nhan Key Ph?m vi（
                    <el-input-number class="loose-input" v-model="allData[14].BatchForm.MinValue" :step="1" :min="allData[14].BatchForm.Min" :max="allData[14].BatchForm.Max"> </el-input-number>
                    ~
                    <el-input-number class="loose-input" v-model="allData[14].BatchForm.MaxValue" :step="1" :min="allData[14].BatchForm.Min" :max="allData[14].BatchForm.Max"> </el-input-number>）
                    Nhan：
                    <el-input-number class="loose-input" v-model="allData[14].BatchForm.Odds" :precision="2" :step="1" :min="0"></el-input-number>
                    <el-button type="primary" class="handle-del mr10" @click="batchModifyOdds(14)" >S?a ??i hàng lo?t</el-button>
                  </el-breadcrumb-item>
                </div>
              </el-card>
              <el-card class="box-card">
                <el-button type="primary" class="handle-del mr10" @click="getData(14)" >Làm m?i</el-button>
                <el-table
                    :data="allData[14].tableData"
                    border
                    class="table"
                    ref="multipleTable"
                    header-cell-class-name="table-header"
                  ...
                  <el-table-column label="?i?u hành" width="180" align="center">
                    <template slot-scope="scope">
                      <el-button
                          type="text"
                          icon="el-icon-edit"
                          @click="handleEdit(14,scope.$index, scope.row)"
                      >Ch?nh s?a
                      </el-button>
                    </template>
                  </el-table-column>
            ...
            <el-tab-pane label="??c bi?t gi?i ??c bi?t m?t A" name="tab3">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    Nhan Key Ph?m vi（
                    ...
                    <el-button type="primary" class="handle-del mr10" @click="batchModifyOdds(3)" >S?a ??i hàng lo?t</el-button>
                  </el-breadcrumb-item>
                </div>
              </el-card>
              <el-card class="box-card">
                <el-button type="primary" class="handle-del mr10" @click="getData(3 )" >Làm m?i</el-button>
                <el-table
            ...
            <el-tab-pane label="??c bi?t gi?i ??c bi?t m?t B" name="tab15">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    Nhan Key Ph?m vi（
                    <el-input-number class="loose-input" v-model="allData[15].BatchForm.MinValue" :step="1" :min="allData[15].BatchForm.Min" :max="allData[15].BatchForm.Max"> </el-input-number>
                    ~
                    <el-input-number class="loose-input" v-model="allData[15].BatchForm.MaxValue" :step="1" :min="allData[15].BatchForm.Min" :max="allData[15].BatchForm.Max"> </el-input-number>）
                    Nhan：
                    <el-input-number class="loose-input" v-model="allData[15].BatchForm.Odds" :precision="2" :step="1" :min="0"></el-input-number>
                    <el-button type="primary" class="handle-del mr10" @click="batchModifyOdds(15)" >S?a ??i hàng lo?t</el-button>
                  </el-breadcrumb-item>
                </div>
              </el-card>
              <el-card class="box-card">
                <el-button type="primary" class="handle-del mr10" @click="getData(15)" >Làm m?i</el-button>
                <el-table
                    :data="allData[15].tableData"
                    border
                    class="table"
                    ref="multipleTable"
                    header-cell-class-name="table-header"
                  ...
                  <el-table-column label="?i?u hành" width="180" align="center">
                    <template slot-scope="scope">
                      <el-button
                          type="text"
                          icon="el-icon-edit"
                          @click="handleEdit(15,scope.$index, scope.row)"
                      >Ch?nh s?a
                      </el-button>
                    </template>
                  </el-table-column>
            ...
            <el-tab-pane label="??c bi?t gi?i nh?t m?t A" name="tab4">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    Nhan Key Ph?m vi（
                    ...
                    <el-button type="primary" class="handle-del mr10" @click="batchModifyOdds(4)" >S?a ??i hàng lo?t</el-button>
                  </el-breadcrumb-item>
                </div>
              </el-card>
              <el-card class="box-card">
                <el-button type="primary" class="handle-del mr10" @click="getData(4 )" >Làm m?i</el-button>
            ...
            <el-tab-pane label="??c bi?t gi?i nhát  m?t B" name="tab16">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    Nhan Key Ph?m vi（
                    <el-input-number class="loose-input" v-model="allData[16].BatchForm.MinValue" :step="1" :min="allData[16].BatchForm.Min" :max="allData[16].BatchForm.Max"> </el-input-number>
                    ~
                    <el-input-number class="loose-input" v-model="allData[16].BatchForm.MaxValue" :step="1" :min="allData[16].BatchForm.Min" :max="allData[16].BatchForm.Max"> </el-input-number>）
                    Nhan：
                    <el-input-number class="loose-input" v-model="allData[16].BatchForm.Odds" :precision="2" :step="1" :min="0"></el-input-number>
                    <el-button type="primary" class="handle-del mr10" @click="batchModifyOdds(16)" >S?a ??i hàng lo?t</el-button>
                  </el-breadcrumb-item>
                </div>
              </el-card>
              <el-card class="box-card">
                <el-button type="primary" class="handle-del mr10" @click="getData(16)" >Làm m?i</el-button>

                <el-table
                    :data="allData[16].tableData"
                    border
                    class="table"
                    ref="multipleTable"
                    header-cell-class-name="table-header"
                  ...
                  <el-table-column label="?i?u hành" width="180" align="center">
                    <template slot-scope="scope">
                      <el-button
                          type="text"
                          icon="el-icon-edit"
                          @click="handleEdit(16,scope.$index, scope.row)"
                      >Ch?nh s?a
                      </el-button>
                    </template>
                  </el-table-column>
            ...
            <el-tab-pane label="??c bi?t gi?i nhì m?t A" name="tab5">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    Nhan Key Ph?m vi（
                    ...
                    <el-button type="primary" class="handle-del mr10" @click="batchModifyOdds(5)" >S?a ??i hàng lo?t</el-button>
                  </el-breadcrumb-item>
                </div>
              </el-card>
              <el-card class="box-card">
                <el-button type="primary" class="handle-del mr10" @click="getData(5 )" >Làm m?i</el-button>
                <el-table
            ...
            <el-tab-pane label="??c bi?t gi?i nhì m?t B" name="tab17">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    Nhan Key Ph?m vi（
                    <el-input-number class="loose-input" v-model="allData[17].BatchForm.MinValue" :step="1" :min="allData[17].BatchForm.Min" :max="allData[17].BatchForm.Max"> </el-input-number>
                    ~
                    <el-input-number class="loose-input" v-model="allData[17].BatchForm.MaxValue" :step="1" :min="allData[17].BatchForm.Min" :max="allData[17].BatchForm.Max"> </el-input-number>）
                    Nhan：
                    <el-input-number class="loose-input" v-model="allData[17].BatchForm.Odds" :precision="2" :step="1" :min="0"></el-input-number>
                    <el-button type="primary" class="handle-del mr10" @click="batchModifyOdds(17)" >S?a ??i hàng lo?t</el-button>
                  </el-breadcrumb-item>
                </div>
              </el-card>
              <el-card class="box-card">
                <el-button type="primary" class="handle-del mr10" @click="getData(17)" >Làm m?i</el-button>
                <el-table
                    :data="allData[17].tableData"
                    border
                    class="table"
                    ref="multipleTable"
                    header-cell-class-name="table-header"
                  ...
                  <el-table-column label="?i?u hành" width="180" align="center">
                    <template slot-scope="scope">
                      <el-button
                          type="text"
                          icon="el-icon-edit"
                          @click="handleEdit(17,scope.$index, scope.row)"
                      >Ch?nh s?a
                      </el-button>
                    </template>
                  </el-table-column>
              ...
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    ...
                    <el-button type="primary" class="handle-del mr10" @click="batchModifyOdds(6)" >S?a ??i hàng lo?t</el-button>
                  </el-breadcrumb-item>
                </div>
              </el-card>
              <el-card class="box-card">
                <el-button type="primary" class="handle-del mr10" @click="getData(6 )" >Làm m?i</el-button>
                <el-table
            ...
            <el-tab-pane label="3 Càng" name="tab7">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    Nhan Key Ph?m vi（
                    ...
                    <el-button type="primary" class="handle-del mr10" @click="batchModifyOdds(7)" >S?a ??i hàng lo?t</el-button>
                  </el-breadcrumb-item>
                </div>
              </el-card>
              <el-card class="box-card">
                <el-button type="primary" class="handle-del mr10" @click="getData(7 )" >Làm m?i</el-button>
                <el-table
            ...
            <el-tab-pane label="Xiên 2" name="tab8">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    Nhan Key Ph?m vi（
                    ...
                    <el-button type="primary" class="handle-del mr10" @click="batchModifyOdds(8)" >S?a ??i hàng lo?t</el-button>
                  </el-breadcrumb-item>
                </div>
              </el-card>
              <el-card class="box-card">
                <el-button type="primary" class="handle-del mr10" @click="getData(8 )" >Làm m?i</el-button>
                <el-table
            ...
            <el-tab-pane label="Xiên 3" name="tab9">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    Nhan Key Ph?m vi（
                    ...
                    <el-button type="primary" class="handle-del mr10" @click="batchModifyOdds(9)" >S?a ??i hàng lo?t</el-button>
                  </el-breadcrumb-item>
                </div>
              </el-card>
              <el-card class="box-card">
                <el-button type="primary" class="handle-del mr10" @click="getData(9 )" >Làm m?i</el-button>
                <el-table
                ...
                >
                  ...
                  <el-table-column prop="OneUserMinBet" label="T?i thi?u1 ng??i"></el-table-column>
                  <el-table-column prop="OneUserMaxBet" label="T?i ?a 1 ng??i"></el-table-column>
                  <el-table-column prop="AllUserMaxBet" label="T?i ?a toàn b?"></el-table-column>
            ...
            <el-tab-pane label="S? màu" name="tab10">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    Nhan Key Ph?m vi（
                    ...
                    <el-button type="primary" class="handle-del mr10" @click="batchModifyOdds(10)" >S?a ??i hàng lo?t</el-button>
                  </el-breadcrumb-item>
                </div>
              </el-card>
              <el-card class="box-card">
                <el-button type="primary" class="handle-del mr10" @click="getData(10 )" >Làm m?i</el-button>
                <el-table
          ...
          <!-- Chỉnh sửa khung chữ -->
            <el-dialog title="Sửa đổi nhân" :visible.sync="editVisible" width="90%">
                ...
                <el-button type="primary" @click="saveOdds">Xác nhân</el-button>
            </span>
            </el-dialog>
        </div>
    </div>
            ...
            batchModifyOdds(t){
                ...
                request({
                    ...
                    if (res.code == 200) {
                        ...
                        this.$message.success(`Chỉnh sửa ${this.form.OddsDes} Thành công`);
