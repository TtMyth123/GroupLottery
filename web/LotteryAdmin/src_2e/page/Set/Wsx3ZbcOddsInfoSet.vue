  ...
  <div>
    <div class="container">
      <el-tabs v-model="activeName" >
        <el-tab-pane label="Nhân" name="tab0">
          ...
          <el-card class="box-card">
            ...
            >
              ...
              <el-table-column prop="OddsType" label="NhânKey" width="90" align="center"></el-table-column>
              <el-table-column prop="OddsDes" label="Nhân名称"></el-table-column>
      ...
      <el-dialog title="Chỉnh sửa số nhân" :visible.sync="editVisible" width="90%">
        <el-form ref="form" :model="form"  label-width="100px">
          <el-form-item label="NhânKey" prop="OddsType">
...
export default {
  ...
  methods: {
    ...
    getData(t) {
      ...
      console.log('OK');
      request({ url: 'api/getwsxzbcoddslist', method: 'post' ,data:data1}).then((res) => {
        console.log(res);
        if (res.code == 200) {
