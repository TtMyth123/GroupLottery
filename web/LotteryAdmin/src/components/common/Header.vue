<template>
    <div class="header">
      ...
      <el-dialog title="修改密码" :visible.sync="dialogModifyPwd.Visible" width="300px">
        <el-form ref="form" :model="dialogModifyPwd.fromModifyPwd" label-width="100px">
          <el-form-item label="原密码" width="100">
            <el-input type="password" v-model="dialogModifyPwd.fromModifyPwd.OldPwd"></el-input>
          </el-form-item>
          <el-form-item label="新密码">
            <el-input type="password" v-model="dialogModifyPwd.fromModifyPwd.NewPwd"></el-input>
          </el-form-item>
        </el-form>
        <span slot="footer" class="dialog-footer">
      <el-button @click="dialogModifyPwd.Visible=false">取 消</el-button>
        ...
        methods: {
            ...
            handleCommand(command) {
                if (command == 'loginout') {
                    ...
                    this.dialogModifyPwd.Visible = true;
                  this.dialogModifyPwd.fromModifyPwd.OldPwd = '';
                  this.dialogModifyPwd.fromModifyPwd.NewPwd = '';

                }
            },
          doModifyPwd(){
            request({ url: 'sys/modifypwd', method: 'post', data: this.dialogModifyPwd.fromModifyPwd }).then((res) => {
              if (res.code == 200) {
                this.$message.success("修改成功");
                this.dialogModifyPwd.Visible = false;
              } else {
