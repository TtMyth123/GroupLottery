    ...
    <div>
        <div class="container">
          <el-tabs v-model="activeName" >
            <el-tab-pane label="大小单双" name="tab0">
            ...
            <el-tab-pane label="头等-头特" name="tab1">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    赔率Key范围（
            ...
            <el-tab-pane label="头等-尾特" name="tab2">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    赔率Key范围（
            ...
            <el-tab-pane label="一等-头特" name="tab11">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    赔率Key范围（
            ...
            <el-tab-pane label="一等-尾特" name="tab12">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    赔率Key范围（
                    ...
                    <el-button type="primary" class="handle-del mr10" @click="batchModifyOdds(12)" >批量修改</el-button>
                  </el-breadcrumb-item>
                </div>
              </el-card>
              <el-card class="box-card">
                <el-button type="primary" class="handle-del mr10" @click="getData(12)" >刷新</el-button>
                <el-table
            ...
            <el-tab-pane label="二等-头特" name="tab13">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    赔率Key范围（
                    ...
                    <el-button type="primary" class="handle-del mr10" @click="batchModifyOdds(13)" >批量修改</el-button>
                  </el-breadcrumb-item>
                </div>
              </el-card>
              <el-card class="box-card">
                <el-button type="primary" class="handle-del mr10" @click="getData(13)" >刷新</el-button>
                <el-table
            ...
            <el-tab-pane label="二等-尾特" name="tab14">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    赔率Key范围（
                    ...
                    <el-button type="primary" class="handle-del mr10" @click="batchModifyOdds(14)" >批量修改</el-button>
                  </el-breadcrumb-item>
                </div>
              </el-card>
              <el-card class="box-card">
                <el-button type="primary" class="handle-del mr10" @click="getData(14)" >刷新</el-button>
                <el-table
            ...
            <el-tab-pane label="头等特码 A面" name="tab3">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    赔率Key范围（
            ...
            <el-tab-pane label="头等特码 B面" name="tab15">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    赔率Key范围（
                    ...
                    <el-button type="primary" class="handle-del mr10" @click="batchModifyOdds(15)" >批量修改</el-button>
                  </el-breadcrumb-item>
                </div>
              </el-card>
              <el-card class="box-card">
                <el-button type="primary" class="handle-del mr10" @click="getData(15)" >刷新</el-button>
                <el-table
            ...
            <el-tab-pane label="一等特码 A面" name="tab4">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    赔率Key范围（
            ...
            <el-tab-pane label="一等特码 B面" name="tab16">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    赔率Key范围（
                    ...
                    <el-button type="primary" class="handle-del mr10" @click="batchModifyOdds(16)" >批量修改</el-button>
                  </el-breadcrumb-item>
                </div>
              </el-card>
              <el-card class="box-card">
                <el-button type="primary" class="handle-del mr10" @click="getData(16)" >刷新</el-button>
            ...
            <el-tab-pane label="二等特码 A面" name="tab5">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    赔率Key范围（
            ...
            <el-tab-pane label="二等特码 B面" name="tab17">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    赔率Key范围（
                    ...
                    <el-button type="primary" class="handle-del mr10" @click="batchModifyOdds(17)" >批量修改</el-button>
                  </el-breadcrumb-item>
                </div>
              </el-card>
              <el-card class="box-card">
                <el-button type="primary" class="handle-del mr10" @click="getData(17)" >刷新</el-button>
                <el-table
            ...
            <el-tab-pane label="二连位" name="tab6">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    赔率Key范围（
            ...
            <el-tab-pane label="三连位" name="tab7">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    赔率Key范围（
            ...
            <el-tab-pane label="平码两位区" name="tab8">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    赔率Key范围（
            ...
            <el-tab-pane label="平码三位区" name="tab9">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    赔率Key范围（
            ...
            <el-tab-pane label="波色" name="tab10">
              <el-card class="box-card">
                <div>
                  <el-breadcrumb-item>
                    赔率Key范围（
