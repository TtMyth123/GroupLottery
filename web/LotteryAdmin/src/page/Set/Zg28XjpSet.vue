    ...
    <div>
        <div class="container">
            <el-tabs v-model="activeName" >
              ...
              <el-tab-pane label="对顺豹子" name="tab1">
                <el-card class="box-card">
                  <div>
                    <el-breadcrumb-item>
                      赔率Key范围（
              ...
              <el-tab-pane label="波色" name="tab2">
                <el-card class="box-card">
                  <div>
                    <el-breadcrumb-item>
                      赔率Key范围（
              ...
              <el-tab-pane label="龙虎和" name="tab3">
                <el-card class="box-card">
                  <div>
                    <el-breadcrumb-item>
                      赔率Key范围（
              ...
              <el-tab-pane label="庄闲" name="tab4">
                <el-card class="box-card">
                  <div>
                    <el-breadcrumb-item>
                      赔率Key范围（
              ...
              <el-tab-pane label="数值" name="tab5">
                <el-card class="box-card">
                  <div>
                    <el-breadcrumb-item>
                      赔率Key范围（
