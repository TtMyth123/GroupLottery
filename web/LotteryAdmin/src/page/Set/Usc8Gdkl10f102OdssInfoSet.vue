    ...
    <div>
        <div class="container">
            <el-tabs v-model="activeName" >
              <el-tab-pane label="总和" name="tab0">
              ...
              <el-tab-pane label="第一球" name="tab1">
                <el-card class="box-card">
                  <div>
                    <el-breadcrumb-item>
                      赔率Key范围（
              ...
              <el-tab-pane label="第二球" name="tab2">
                <el-card class="box-card">
                  <div>
                    <el-breadcrumb-item>
                      赔率Key范围（
              ...
              <el-tab-pane label="第三球" name="tab3">
                <el-card class="box-card">
                  <div>
                    <el-breadcrumb-item>
                      赔率Key范围（
              ...
              <el-tab-pane label="第四球" name="tab4">
                <el-card class="box-card">
                  <div>
                    <el-breadcrumb-item>
                      赔率Key范围（
              ...
              <el-tab-pane label="第五球" name="tab5">
                <el-card class="box-card">
                  <div>
                    <el-breadcrumb-item>
                      赔率Key范围（
              ...
              <el-tab-pane label="第六球" name="tab6">
                <el-card class="box-card">
                  <div>
                    <el-breadcrumb-item>
                      赔率Key范围（
              ...
              <el-tab-pane label="第七球" name="tab7">
                <el-card class="box-card">
                  <div>
                    <el-breadcrumb-item>
                      赔率Key范围（
              ...
              <el-tab-pane label="第八球" name="tab8">
                <el-card class="box-card">
                  <div>
                    <el-breadcrumb-item>
                      赔率Key范围（
...
<script>
    ...
    export default {
        name: 'Usc8Gdkl10f102OdssInfoSet',
        data() {
            return {
                ...
                allData:[
                  {I:0, BigTypes: [9], tableData:[] ,BatchForm:{MinValue:317,MaxValue:322,Odds:9.9,Min:317,Max:322}, },
                  {I:1, BigTypes: [1], tableData:[] ,BatchForm:{MinValue:1,MaxValue:37,Odds:9.9,Min:1,Max:37}, },
                  {I:2, BigTypes: [2], tableData:[] ,BatchForm:{MinValue:38,MaxValue:74,Odds:9.9,Min:38,Max:74}, },
                  {I:3, BigTypes: [3], tableData:[] ,BatchForm:{MinValue:75,MaxValue:111,Odds:9.9,Min:75,Max:111}, },
                  {I:4, BigTypes: [4], tableData:[] ,BatchForm:{MinValue:112,MaxValue:148,Odds:9.9,Min:112,Max:148}, },
                  {I:5, BigTypes: [5], tableData:[] ,BatchForm:{MinValue:149,MaxValue:185,Odds:9.9,Min:149,Max:185}, },
                  {I:6, BigTypes: [6], tableData:[] ,BatchForm:{MinValue:186,MaxValue:222,Odds:9.9,Min:186,Max:222}, },
                  {I:7, BigTypes: [7], tableData:[] ,BatchForm:{MinValue:223,MaxValue:259,Odds:9.9,Min:223,Max:259}, },
                  {I:8, BigTypes: [8], tableData:[] ,BatchForm:{MinValue:260,MaxValue:296,Odds:9.9,Min:260,Max:296}, },
